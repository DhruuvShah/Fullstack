...
import { Home, Wrench, Database, Sun, Moon, Command, Server } from "lucide-react";
...
function Layout() {
  ...
  return <div className="layout-container">
    ...
    /* Animated Mesh Background */
      ...
      <div className="layout-bg">
        <div className="layout-bg-blob-1" style={{ animationDuration: "10s" }} />
        <div className="layout-bg-blob-2" style={{ animationDuration: "14s" }} />
        <div className="layout-bg-blob-3" style={{ animationDuration: "12s" }} />
      </div>
  ...
  >
    ...
    key={item.path}
    to={item.path}
    className={({ isActive }) => `layout-nav-item ${isActive ? "layout-nav-item-active" : "layout-nav-item-inactive"}`}
  >
