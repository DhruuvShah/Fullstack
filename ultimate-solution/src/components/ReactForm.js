...
function ReactForm() {
  ...
  return <form onSubmit={handleSubmit} className="reactform-container">
  ...
  >
      ...
      <div className="reactform-card">
        <div className="reactform-field">
          ...
          <input type="text" name="email" value={email} onChange={handleChange} className="reactform-input" placeholder="name@example.com" />
        </div>
        <div className="reactform-divider" />
        <div className="reactform-field-bottom">
          <label className="reactform-label">Password</label>
          <input type="password" name="password" value={password} onChange={handleChange} className="reactform-input" placeholder="••••••••" />
        </div>
      </div>
      <motion.button whileTap={{ scale: 0.97 }} type="submit" className="reactform-submit">Submit</motion.button>
    </form>;
}
export {
  ReactForm
