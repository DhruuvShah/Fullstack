...
export const SurName = createContext('Prajapati');
export const Tradmark = createContext('JG UNIVERSITY AHMEDABAD GUJARAT');
export const NumberContext = createContext({ num1: 10, num2: 20, sum: 30 });
    ...
    <div className="contextdemo-container">
      ...
      <div className="contextdemo-card-flex">
        <div>
          ...
          <p className="contextdemo-text-muted">Num 1: {num1} | Num 2: {num2}</p>
        </div>
