...
fs.writeFile("async-file.txt", asyncContent, (err) => {
  if (err) {
    ...
    console.log("✅ Async file written successfully: async-file.txt");
...
if (fs.existsSync("sample.txt")) {
  ...
  console.log("❌ sample.txt does not exist");
}
...
// 9. Delete a file (commented out for safety)
// console.log('\n9. Deleting file...');
// fs.unlinkSync('async-file.txt');
