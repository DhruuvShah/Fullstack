  ...
  return (
    <div className="modern-calculator">
      ...
      <div className="buttons">
        ...
        <button className="btn-warning" onClick={() => addNum("/")}>/</button>
        ...
        <button className="btn-primary" onClick={calculate}>=</button>
        <button className="btn-warning" onClick={() => addNum("+")}>+</button>
        <button className="btn-danger" onClick={clearInput}>C</button>
      </div>
    </div>
  );
}
